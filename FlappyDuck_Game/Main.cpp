...
{
public:
	Cloud(const std::string textname, short ID) {
...
restart:
	...
	std::deque<Cloud*> nuvens;
	nuvens.push_back(new Cloud("nuvemC.png", 1));
	nuvens.push_back(new Cloud("nuvemC.png", 2));
	nuvens.push_back(new Cloud("nuvemC.png", 3));
