...
Moldura<Temp>::Moldura(sf::IntRect tam, std::string texto, Temp in_midle) : frame (tam) , temp(&in_midle) {
	...
	font.loadFromFile("C:\\Users\\Emanuel\\source\\repos\\Jogos\\Tetris_Game\\Fonts\\homespun.ttf");
...
RoundFrame::RoundFrame(sf::IntRect tam_and_pos) {
	...
	textura.loadFromFile("C:\\Users\\Emanuel\\source\\repos\\SFML_testes\\SFML_testes\\RoundFrame.png");
